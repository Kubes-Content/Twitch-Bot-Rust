...
pub mod CharacterContextHandler;
pub mod ClosingCurlyBraceHandler;
pub mod OpeningCurlyBraceHandler;

// use Scope
// use ReadableType

pub struct CharacterHandler {
    opening_curly_brace_handler:OpeningCurlyBraceHandler::OpeningCurlyBraceHandler,
    closing_curly_brace_handler:ClosingCurlyBraceHandler::ClosingCurlyBraceHandler,
}
...
impl CharacterHandler {
    ...
    pub fn register_opening_curly_brace(&mut self, current_scope:&mut Scope){
        ...
        let empty_func = | reading_object:&mut ReadingObject | { };
    ...
    pub fn register_opening_quotation_mark(&mut self, current_scope:&mut Scope) {
        match current_scope.current_context {
            ...
            | ReadableType::PropertyValueObject => {
                let empty_func = | prop_key:&mut ReadingPropertyKey | { };
            ...
            ReadableType::PropertyValueUnknownArray => {
                let finalize_key = |reading_key:&mut ReadingPropertyKey | {
                    reading_key.set_paired_value_type(PropertyType::String_List);
                ...
                let init_value = |reading_value:&mut ReadingPropertyValue | {
                    reading_value.value_type = PropertyType::String_List;
                };
    ...
    pub fn register_closing_quotation_mark(&mut self, current_scope:&mut Scope) {
        match current_scope.current_context {
            ...
            | ReadableType::PropertyValuePrimitiveAsString => {
                ...
                current_scope.use_current_reading_property_list(PropertyType::String_List, list_func);
        ...
        match current_scope.current_context {
            ...
            ReadableType::PropertyValueUnknownArray => {
                let finalize_value_func = |reading_array_value:&mut ReadingPropertyValue | {
                    reading_array_value.value_type = PropertyType::Empty_List;
                ...
                let finalize_key_func = | reading_key:&mut ReadingPropertyKey | {
                    reading_key.set_paired_value_type(PropertyType::Empty_List);
                };
            ...
            ReadableType::PropertyValueObject => {
                ...
                current_scope.use_current_reading_property_list(PropertyType::JSON_Object_List, func);
            },
            ReadableType::PropertyValueStringArray => {
                let func = | string_vector_to_finalize:&mut ReadingPropertyValue | {
                    string_vector_to_finalize.register_closing_bracket();
                };
                current_scope.use_current_reading_property_list(PropertyType::String_List, func);
    ...
    pub fn register_character<T> (character_context_handler:&mut T, context:ReadableType, current_scope:&mut Scope)
        where T : CharacterContextHandler::CharacterContextHandler {
        match context {
            ReadableType::None => {
