...
impl TokenData {
    ...
    pub fn from_json(json_object: JsonObject, client_id: ClientId) -> TokenData {
        ...
        let _refresh_token = {
            ...
            json_object.use_property_value(
                JsonPropertyKey::new(
                    PROPERTY_NAME_REFRESH_TOKEN.to_string(),
        ...
        let new_scope = {
            ...
            json_object.use_property_value(
                JsonPropertyKey::new(PROPERTY_NAME_SCOPE.to_string(), PropertyType::Invalid),
                get_scope,
            );
            out_scope.unwrap()
        };
        ...
        let new_token_type =
            json_object.get_string_property_value(PROPERTY_NAME_TOKEN_TYPE.to_string());
    ...
    pub fn update(&mut self, validation_token: ValidationToken) {
        if validation_token.expires_in <= 0 {
            unimplemented!();
        }
