use crate::User::UserProperties::{UserId, UserLogin, UserDisplayName, UserType, UserBroadcasterType, UserDescription, UserProfileImageUrlFormat, UserOfflineImageUrlFormat, UserViewCount, UserEmail};
...
use std::str::FromStr;
use std::io::{BufRead};
use crate::{get_input_from_console, request_user_oauth_token};
use std::error::Error;
...
impl Data {
    ...
    pub fn from_json(json_data_object: JsonObject, logger: &dyn Logger) -> Data {
